...
CREATE TABLE daily_logs (
    ...
    soreness_level NUMERIC CHECK (soreness_level >= 1 AND soreness_level <= 10),
    ...
    hunger_level NUMERIC CHECK (hunger_level >= 1 AND hunger_level <= 10),
    libido NUMERIC CHECK (libido >= 1 AND libido <= 10),
