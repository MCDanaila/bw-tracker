...
export const MOCK_EXERCISES: Exercise[] = [
  // ── CHEST ────────────────────────────────────────────────────────────────
  {
    ...
    equipment: ['barbell'],
    instructions: 'Lower bar under control, hold tension briefly at bottom, explode concentrically. Incline variant shifts emphasis to upper chest.',
  ...
  },
  {
    ...
    instructions: 'Set incline 15–45° depending on target area. 2\'\' eccentric, explode concentrically. Record load and reps each session.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: '3\'\' eccentric on every rep. Lower all the way, stretch fully, drive concentrically. Focus on chest contraction at peak.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: '3\'\' eccentric, control at bottom. Add bands or chains for resistance if bodyweight is insufficient. Lean forward slightly to bias chest over triceps.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  ...
  // ── BACK ─────────────────────────────────────────────────────────────────
  {
    ...
    equipment: ['cable'],
    instructions: 'Use close-grip attachment. Squeeze the back hard at end of concentric. Do not cross the torso line — attachment stops 2–3 fingers from body.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    equipment: ['t_bar'],
    instructions: 'Squeeze the back hard at end of concentric. Do not exceed the torso line. Prefer chest-supported version if the machine is available.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    equipment: ['cable'],
    instructions: 'Pronated grip. Squeeze the back hard at the end of the concentric. Do not pull past the torso line.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    auxiliary_muscles: [],
    equipment: ['cable'],
    instructions: 'Ramp up sets of 8 increasing load until you can no longer complete all 8 reps. Stop there — used as neural warm-up before heavy back work.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    instructions: 'Squeeze the back hard at end of concentric on every rep. Can alternate with pronated pulldown.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  // ── SHOULDERS ────────────────────────────────────────────────────────────
  {
    ...
    instructions: 'Controlled execution. Do not go below 15° of humeral abduction. Keep constant tension throughout. 40\'\' rest between sets.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: '2–3\'\' eccentric. Lower controlled, drive explosively. Record load each session and beat it the following week.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: 'Squeeze the posterior delts hard at every rep. Must feel them actively working throughout.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  // ── ARMS ─────────────────────────────────────────────────────────────────
  {
    ...
    auxiliary_muscles: ['deltoid_anterior'],
    equipment: ['dumbbell'],
    instructions: 'Squeeze biceps hard at the top. 2\'\' eccentric maintaining tension. Incline variant increases stretch at bottom.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    auxiliary_muscles: ['deltoid_anterior'],
    equipment: ['cable'],
    instructions: 'Squeeze triceps hard at the bottom. Spread the rope apart at the bottom for a more physiological arc.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    instructions: 'Stretch as far as possible at the bottom (2\'\' hold), then drive concentrically with controlled movement.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    auxiliary_muscles: ['deltoid_anterior'],
    equipment: ['machine'],
    instructions: '10 reps + 10\'\' ISO hold at mid-ROM as finisher. Scale load to always complete 10 reps.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  // ── LEGS ─────────────────────────────────────────────────────────────────
  {
    ...
    equipment: ['machine'],
    instructions: 'Warm up to target load. 3\'\' eccentric, hold briefly at bottom, explode concentrically. If exceeding rep range, increase load next session.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: 'Controlled descent, hold tension briefly at bottom, explode concentrically. Use bands on Smith for unloading at the bottom if needed.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    auxiliary_muscles: ['hamstrings', 'adductors'],
    equipment: ['machine'],
    instructions: '1\'\' pause at the bottom on each rep. Precise and controlled. Single-leg variant: one side at a time, rest 2\'\' then switch.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    auxiliary_muscles: [],
    equipment: ['machine'],
    instructions: 'Ramp up sets of 10 increasing load each time. 60\'\' rest only between sets. Focus on quad contraction at the top.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    equipment: ['machine'],
    instructions: 'Squeeze hamstrings hard at every rep. Seated variant offers greater stretch at the hip.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: 'Touch at the bottom, release tension slightly, then explode up. Focus on hamstring stretch. 3\'\' squeeze variant: hold at top for 3\'\' each rep — use lighter load.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: 'Ramp up sets of 12 per leg. Rest between legs. Controlled descent, keep tension at the bottom.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    auxiliary_muscles: [],
    equipment: ['machine'],
    instructions: 'Squeeze hard at the top. Full stretch at the bottom. Muscle Round: 4+4+4+4+4+4 with 10\'\' rest, failure only on the last mini-set. Standing variant: gastrocnemius becomes primary.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  {
    ...
    instructions: 'Squeeze glutes at the top. Advanced variant: 5 reps with 4\'\' squeeze, 5 reps with 2\'\' squeeze, then max partials at the top.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
  ...
  // ── TRAPS ────────────────────────────────────────────────────────────────
  {
    ...
    instructions: 'First set high reps for pump. Second set heavier for 12–15 reps. Full ROM, squeeze at the top.',
    created_at: '2026-04-30T00:00:00Z',
    updated_at: '2026-04-30T00:00:00Z',
  },
];
