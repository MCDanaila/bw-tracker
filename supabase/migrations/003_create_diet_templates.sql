-- P2-T01: Create diet_templates and diet_template_items tables
...
-- Indexes
CREATE INDEX idx_diet_templates_coach ON diet_templates(coach_id);
CREATE INDEX idx_diet_template_items_template ON diet_template_items(template_id);
CREATE INDEX idx_diet_template_items_food ON diet_template_items(food_id);
...
-- Athletes cannot see templates
-- (No SELECT policy for non-coaches means they get nothing)

-- Template items: coaches can manage items in their own templates
